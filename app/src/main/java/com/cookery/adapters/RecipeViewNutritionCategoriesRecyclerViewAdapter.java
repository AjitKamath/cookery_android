...
public class RecipeViewNutritionCategoriesRecyclerViewAdapter extends RecyclerView.Adapter<RecipeViewNutritionCategoriesRecyclerViewAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.common_ingredient_nutrition_category_item, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View view) {
            super(view);
            ingredient_view_nutrition_category_item_name_tv = view.findViewById(R.id.common_ingredient_nutrition_category_item_name_tv);
            ingredient_view_nutrition_category_item_nutritions_rv = view.findViewById(R.id.common_ingredient_nutrition_category_item_nutritions_rv);
        }
    }
}