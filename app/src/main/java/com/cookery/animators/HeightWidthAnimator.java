...
/**
 * Created by ajit on 18/3/18.
 */

// Subclass of Android's android.view.animation.Animation
public class HeightWidthAnimator extends Animation {
    ...
    // Constructor
    public HeightWidthAnimator(View view, int toDimension, Type type, long duration) {
        // Setup references
        // the view to animate
        this.view = view;
